...
export default function ColorPickerPage() {
  ...
  return (
    <div
      className={`min-h-screen transition-colors duration-300 ${theme === 'dark' ? 'bg-gray-900 text-gray-100' : ' text-gray-900'}`}
    >
      <div className="container mx-auto px-4 py-12">
        ...
        <div
          className={`rounded-xl p-6 shadow-lg ${theme === 'dark' ? 'bg-gray-800' : ''}`}
        >
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <input
                    ...
                    className={`flex-1 p-2 rounded-lg border ${theme === 'dark' ? 'bg-gray-700 border-gray-600' : ' border-gray-300'}`}
                  />
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="flex">
                    ...
                    <button
                      ...
                      className={`px-3 rounded-r-lg flex items-center ${theme === 'dark' ? 'bg-blue-600 hover:bg-blue-700' : 'bg-blue-500 hover:bg-blue-600'} text-white`}
                    >
...
function generatePalette(baseColor: string): string[] {
  // Simple palette generation - in a real app you might use a color library
